...
########### restituisce la matrice di calibrazione del proiettore coi parametri 
#  ###########
...
SQUARE_LENGTH = 0.041        # Dimensione lato quadrato in metri (es. 4cm)
MARKER_LENGTH = 0.021         # Dimensione lato marker ArUco in metri (es. 2cm)
ARUCO_DICT = aruco.getPredefinedDictionary(aruco.DICT_6X6_250)

# Cartella contenente le tue foto (es. .jpg o .png)
IMAGE_FOLDER = 'C:\\Users\\chiar\\Desktop\\Tesi Magistrale\\Prove_Tesi\\output_images'
